<div id="category<?=$categoryId?>" class="tab-pane <?=($active ? 'active': '')?>" >
  <div class="row popup-gallery">
      ...
      <div class="col-xs-12 col-sm-6 col-md-3">
        <div class="sol">
            <img class="img-responsive" src="<?=ProyectoWeb\app\utils\Utils::generateValidHTML5src($itemGaleria->getUrlPortfolio())?>" alt="<?=$itemGaleria->getDescripcion()?>">
            <div class="behind">
                <div class="head text-center">
                <ul class="list-inline">
                    <li>
                    <a class="gallery" href="<?=ProyectoWeb\app\utils\Utils::generateValidHTML5src($itemGaleria->getUrlGallery())?>" data-toggle="tooltip" data-original-title="Quick View">
                        <i class="fa fa-eye"></i>
                    </a>
                    </li>
                    <li>
